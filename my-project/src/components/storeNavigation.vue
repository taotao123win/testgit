		...
		<div class="el-top">
			<div class="" style="float: left;">
				<el-breadcrumb separator-class="el-icon-arrow-right">
					...
					<el-breadcrumb-item>分店导航</el-breadcrumb-item>
				</el-breadcrumb>
			</div>
...
<script>
	export default {
		...
		methods: {
        	...
        	this.$router.push({ name:'navigationalMap', params: {id:index}})
      },
			compareTime() {
			...
			goMap() {
				this.$router.push({
					path: '/storeNavigation/navigationalMap'
				})
			},
			//    jqprint(){
